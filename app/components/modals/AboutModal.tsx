...
const capabilityGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      "Use the CSS Color Tool to find CSS files, preview color changes, and apply them.",
    ],
  },
  {
    title: "Payment Timeline and Gateway Tools",
    items: [
      "Build payment trace timelines from logs, HAR files, payloads, screenshots, and gateway responses.",
      "Reconstruct frontend, backend, gateway, webhook, database, UI, and device events.",
      ...
      "Decode EMV/TLV blobs separately from full payment timelines.",
